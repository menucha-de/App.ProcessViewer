package havis.app.processviewer.ui.client;
...
import havis.app.processviewer.ui.client.readpoints.ReadPointEditor;
import havis.app.processviewer.ui.client.readpoints.ReadPointEditorPresenter;
import havis.app.processviewer.ui.client.readpoints.ReadPointEditorView;
import havis.app.processviewer.ui.client.readpoints.ReadPointEvent;
import havis.app.processviewer.ui.client.sections.HistorySection;
import havis.app.processviewer.ui.client.sections.TagHistorySection;
import havis.app.processviewer.ui.client.sections.ViewerSection;
import havis.app.processviewer.ui.client.tasks.TaskEditor;
import havis.app.processviewer.ui.client.tasks.TaskEditorPresenter;
import havis.app.processviewer.ui.client.tasks.TaskEditorView;
import havis.app.processviewer.ui.client.tasks.TaskEditorView.Mode;
import havis.app.processviewer.ui.client.tasks.TaskEvent;
	...
	private class ChangeReadpointClickHandler implements ClickHandler {
		...
		public void onClick(ClickEvent event) {
			if (readpoint.getName().length() > 0) {
				...
				readpointEditorPresenter.setCurrentMode(havis.app.processviewer.ui.client.readpoints.ReadPointEditorView.Mode.CHANGE);
	...
	private class IconReadpointClickHandler implements ClickHandler {
		...
		public void onClick(ClickEvent event) {
			if (readpoint.getName().length() > 0) {
				...
				readpointEditorPresenter.setVisible(true);
				readpointEditorPresenter.setCurrentMode(havis.app.processviewer.ui.client.readpoints.ReadPointEditorView.Mode.CREATE);
				readpointEditorPresenter.setCurrentPosition(readpoint.getPosition());
				readpointEditorPresenter.setParentTask(parentTask);
				readpointEditorPresenter.setCurrentReadPoint(readpoint);
			}
